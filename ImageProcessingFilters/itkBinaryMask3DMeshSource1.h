 ...
 *
 *=========================================================================*/
#ifndef __itkBinaryMask3DMeshSource1_h
#define __itkBinaryMask3DMeshSource1_h
...
class ITK_EXPORT BinaryMask3DMeshSource1:public ImageToMeshFilter< TInputImage, TOutputMesh >
{
public:
  /** Standard "Self" typedef. */
  typedef BinaryMask3DMeshSource1                        Self;
  ...
  itkTypeMacro(BinaryMask3DMeshSource1, ImageToMeshFilter);
...
private:
  BinaryMask3DMeshSource1(const Self &); //purposely not implemented
...
#include "itkBinaryMask3DMeshSource1.txx"
#endif
