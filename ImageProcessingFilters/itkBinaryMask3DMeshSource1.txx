 ...
 *
 *=========================================================================*/
#ifndef __itkBinaryMask3DMeshSource1_txx
#define __itkBinaryMask3DMeshSource1_txx
...
BinaryMask3DMeshSource1< TInputImage, TOutputMesh >
...
::CreateMesh()
{
  ...
  //  {
  //  std::cout << "BinaryMask3DMeshSource1 : Binary image mask not set";
  //  std::cout << std::endl;
  //  return;
  //  }
